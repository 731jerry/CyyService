...
; 安装程序初始定义常量
!define PRODUCT_NAME "彩盈盈后台管理系统"
!define VERSION_NAME ""
!define PRODUCT_VERSION "2.1.11"
!define PRODUCT_PUBLISHER "彩盈盈网络科技有限公司"
!define PRODUCT_DIR_REGKEY "Software\Microsoft\Windows\CurrentVersion\App Paths\彩盈盈后台管理系统.exe"
...
; MUI Settings / Icons
; 安装包图标
!define MUI_ICON "CyyService\config\install.ico"
...
; 许可协议页面
!insertmacro MUI_PAGE_LICENSE "CyyService\config\lic.txt"
; 安装目录选择页面
...
InstallDir "C:\CyyService"
ShowInstDetails show
ShowUnInstDetails show

Section "MainSection" SEC01
  SetOutPath "C:\CyyService"
...
Section -Post
  ...
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\config\icon.ico"
