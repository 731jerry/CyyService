    ...
    public partial class update : Form
    {
        ...
        public void GetNewVersion()
        {
            try
            {
                ...
                using (FileStream fs = new FileStream(System.Environment.CurrentDirectory + @"\update.exe", FileMode.Create, FileAccess.Write))
                {
                ...
                Process.Start(System.Environment.CurrentDirectory + @"\update.exe");
            }
            catch (Exception e)
            {
